...
const ImageCard = (props) => {
  return (
    <div className="cursor-pointer hover:scale-105 transition-transform duration-500 max-w-[18rem] rounded-lg bg-white/30 backdrop-blur-lg shadow-lg hover:shadow-2xl dark:bg-gray-800/50 p-2">
