...
const Footer = () => {
  return (
    <div name="contact" className="flex flex-col items-center bg-slate-900">
      <h1 className="text-gray-100 text-3xl md:text-5xl font-extrabold pb-10 pt-5">
        Contact Us
      </h1>
      <footer className="w-11/12 md:w-screen">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                ...
                <ul className="text-gray-400 dark:text-gray-400 font-medium space-y-2">
                  <li>
                    <a
                      href="tel:+918509718465"
              ...
              <div>
                ...
                <ul className="text-gray-400 font-medium space-y-2">
                  <li>
                    <a
                      href="mailto:app.gamaru@gmail.com"
                      className="hover:text-teal-400 transition-colors duration-300"
                    >
                      app.gamaru@gmail.com
                    </a>
                  </li>
                  <li>
                    <a
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
              © 2023{" "}
              <a href="https://flowbite.com/" className="hover:text-teal-400">
                Gamaru™
              </a>
              . All Rights Reserved.
            </span>
