...
<div name="contact" className='flex flex-col items-center bg-slate-800'>
<h1 className="text-gray-200  text-3xl md:text-5xl font-extrabold pb-10 pt-5">
        Contact Us
      </h1>
<footer class="bg-white dark:bg-slate-800 w-11/12  md:w-screen">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Gamaru™</a>. All Rights Reserved.
          </span>
